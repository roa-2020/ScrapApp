    ...
    .then(function () {
      ...
      return knex('scraps').insert([
        ...
        },
        {
          ...
          scrap_image: 'https://www.flaticon.com/svg/static/icons/svg/685/685352.svg',
          address: '60 Courtenay Place, Wellington CBD, Wellington 6011',
          latitude: -41.29353332519531,
          longitude: 174.7815704345703,
          user_id: 1,
          collected: false,
        },
        {
        ...
        },
        {
          ...
          address: '74 Courtenay Place, Te Aro, Wellington, New Zealand',
          latitude: -41.29353332519531,
          longitude: 174.7815704345703,
          user_id: 2,
          collected: true,
